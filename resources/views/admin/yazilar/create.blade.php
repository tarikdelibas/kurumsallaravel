    ...
    <div class="container">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{route('admin.yaziCreate')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <fieldset class="form-fieldset">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" name="yazi_gorsel" id="yazi_gorsel">
                                <label class="custom-file-label">Dosya Seç</label>
                                <label id="file-name"></label>
                            </div>
                        </div>
                        <button type="submit" class="btn btn-pill btn-success">Yazı Ekle</button>
                    </fieldset>
                </form>
            </div>
        </div>
...
@section('script')
    ...
    <script type="text/javascript">
        document.querySelector("#yazi_gorsel").onchange = function(){
