        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Faaliyet Ekle</h3>
                </div>
                <form action="{{route('admin.projeCreate')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <fieldset class="form-fieldset">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" name="proje_gorsel" id="proje_gorsel">
                                <label class="custom-file-label">Dosya Seç</label>
                                <label id="file-name"></label>
                            </div>
                        </div>
                        <button type="submit" class="btn btn-pill btn-success">Faaliyet Ekle</button>
                    </fieldset>
                </form>
            </div>
        </div>
...
@section('script')
    ...
    <script type="text/javascript">
        document.querySelector("#proje_gorsel").onchange = function(){
