    ...
    <div class="container">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{route('admin.urunCreate')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <fieldset class="form-fieldset">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" name="urun_gorsel" id="urun_gorsel">
                                <label class="custom-file-label">Dosya Seç</label>
                                <label id="file-name"></label>
                            </div>
                        </div>
                        <button type="submit" class="btn btn-pill btn-success">Ürün Ekle</button>
                    </fieldset>
                </form>
            </div>
        </div>
...
@section('script')
    ...
    <script type="text/javascript">
        document.querySelector("#urun_gorsel").onchange = function(){
